    ...
    <table className="table">
      ...
      <tbody className="table__tbody">
        <tr>
          ...
          <td>1, 2, 3</td>
          <td className="table__github--img"><a href="https://github.com/kevin-sarria/aplicacion_pacientes_veterinaria" target="_blank"><img src="/img/icons/github.svg" alt="Icono Github" /></a></td>
          <td className="table__web--img"><a href="https://administrador-citas-kevin-sarria.netlify.app/" target="_blank"><img src="/img/icons/web.svg" alt="Icono Web" /></a></td>
          <td>
